					...
					<div class="card-block">
						...
						<div class="metafooter">
							<div class="wrapfooter">
								...
								<a href="/user/profile/${element.author}"><img class="author-thumb" src="" alt="${element.author}"></a>
								</span>
								<span class="author-meta">
								<span class="post-name"><a href="/user/profile/${element.author}">${element.author}</a></span><br/>
