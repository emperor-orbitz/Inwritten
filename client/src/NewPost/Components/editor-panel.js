...
//console.log(this.props);
    ...
    Block(node) {
        ...
        switch (node[0]) {
            case 'ol':
                var status = this.state.value.change()
                    //.setBlocks('ol')
            ...
            <div style={{ padding: '0px', height: '100%' }}>
                ...
                <div className='editor-buttons' id='editor-buttons' >
                    ...
                    {arrIconsInline.map((button) => {
                        return (<Icon size='small' key={button.name} name={button.name} icon={button.action} onClick={this.Inline.bind(this, [button.action])}
                            className='editor-editorButtons' />)
                    })}

                    {arrIconsInline2.map((button) => {
                        return (<Icon size='small' key={button.name} name={button.name} onClick={this.Inline.bind(this, [button.action])}
                            className='editor-editorButtons' />)
                    ...
                    {arrIconsBlock.map((button) => {
                        return (<Icon size='small' key={button.name} name={button.name} icon={button.action} onClick={this.Block.bind(this, [button.action])}
                            className='editor-editorButtons' />)

                    })}

                    {/*<Icon name='code' className='editor-editorButtons' onClick={this.link_insert_display} />*/}
